...
import 'package:reddit_clone/features/community/respository/community_repository.dart';
...
final userCommunitiesProvider = StreamProvider((ref) {
  final communnityController = ref.watch(communityControllerProvider.notifier);
  return communnityController.getUserCommunities();
});
